...
ThreadPool::ThreadPool()
    : initThreadSize_(0), threadSizeThreshold_(THREAD_MAX_THRESHOLD), curThreadSize_(0), idleThreadSize_(0), taskSize_(0), taskQueMaxThreshold_(TASK_MAX_THRESHOLD), poolMode_(PoolMode::MODE_FIXED), isPoolRunning_(false)
{
}

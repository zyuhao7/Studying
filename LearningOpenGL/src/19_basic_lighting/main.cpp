...
int main(int argc, char *argv[])
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        float rotate = glfwGetTime() * 0.5f;
        float slowFactor = 0.5f;
        glm::vec3 eulerAnggles(glfwGetTime() * slowFactor, glfwGetTime() * slowFactor, glfwGetTime() * slowFactor);
        glm::qua<float> qu = glm::qua<float>(eulerAnggles);

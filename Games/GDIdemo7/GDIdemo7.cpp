...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_GDIDEMO7));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_GDIDEMO7);
...
BOOL Game_Init(HWND hwnd)
{
	...
	for (int i = 0;i < 12;i++)
	{
		memset(filename, 0, sizeof(filename));  //filename 的初始化

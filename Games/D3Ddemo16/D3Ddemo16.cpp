...
HRESULT Objects_Init()
{
	...
	D3DXVECTOR3 camPos(0.0f, 200.0f, -300.0f);
	D3DXVECTOR3 targetPos(0.0f, 300.0f, 0.0f);

	g_pCamera->SetCameraPosition(&camPos); //设置摄像机所在的位置
	g_pCamera->SetTargetPosition(&targetPos); //设置目标观察点所在的位置

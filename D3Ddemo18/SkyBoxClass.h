...
public:
	...
	BOOL	LoadSkyTextureFromFile(const wchar_t *pFrontTextureFile, const  wchar_t *pBackTextureFile, const wchar_t *pLeftTextureFile, const wchar_t *pRightTextureFile, const wchar_t *pTopTextureFile);  //从文件加载天空盒五个方向上的纹理

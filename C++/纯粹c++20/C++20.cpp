...
//{
//    atomic<A> a;
//    cout << boolalpha << a.is_lock_free() << endl; // false, 编译器可能在背后 偷偷用 mutex / 自旋锁
//    std::cout << "atomic<bool>: " << std::atomic<bool>{}.is_lock_free() << std::endl; // true 通常是 单条 CPU 指令完成
//}
